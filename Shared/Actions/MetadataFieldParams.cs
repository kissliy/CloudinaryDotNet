namespace CloudinaryDotNet.Actions
{
    ...
    public abstract class MetadataFieldBaseParams<T> : BaseParams
    {
        ...
        protected void CheckScalarDataModel(List<Type> allowedValidationTypes)
        {
            if (DataSource != null)
            {
                throw new ArgumentException("DataSource must not be specified");
            }
    ...
    public abstract class MetadataFieldCreateParams<T> : MetadataFieldBaseParams<T>
    {
        ...
        public override void Check()
        {
            ...
            {
                throw new ArgumentException("DefaultValue must be specified");
            }
        }
    ...
    public class EnumMetadataFieldCreateParams : MetadataFieldCreateParams<string>
    {
        ...
        public override void Check()
        {
            ...
            if (DataSource == null)
            {
                throw new ArgumentException("DataSource must be specified");
            }

            if (Validation != null)
            {
                throw new ArgumentException("Validation must not be specified");
            }
    ...
    public class MetadataDataSourceParams : BaseParams
    {
        ...
        {
            var dict = base.ToParamsDictionary();
            var valuesList = Values.Select(
                entry => entry.ToParamsDictionary()).ToList();
    ...
    public class EntryParams : BaseParams
    {
        ...
        /// </summary>
        /// <param name="value">The datasource value.</param>
        /// <param name="externalId">Unique identificator of the datasource entry.</param>
    ...
    public class AndValidationParams : MetadataValidationParams
    {
        ...
        public override void Check()
        {
            ...
            {
                throw new ArgumentException("Rules must be specified");
            }
        }
    ...
    /// </summary>
    public class DeleteDataSourceEntriesParams : BaseParams
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteDataSourceEntriesParams"/> class.
        /// </summary>
        /// <param name="externalIds">IDs of datasource entries to delete.</param>
        public DeleteDataSourceEntriesParams(List<string> externalIds)
        {
        ...
        public override void Check()
        {
            ...
            {
                throw new ArgumentException("ExternalIds must be specified");
            }
        }
