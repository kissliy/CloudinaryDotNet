...
//        public async Task<RawUploadResult> UploadLargeRawAsync(BasicRawUploadParams parameters, int bufferSize = 20 * 1024 * 1024)
//        {
...
//        }
        ...
        public async Task<ImageUploadResult> UploadAsync(ImageUploadParams parameters)
        {
            ...
            return await m_api.AsyncCallAndParse<ImageUploadResult>(HttpMethod.POST, uri, parameters.ToParamsDictionary(), parameters.File);
        }
